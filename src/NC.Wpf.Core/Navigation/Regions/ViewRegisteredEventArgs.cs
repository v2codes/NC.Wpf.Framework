...
namespace NC.Wpf.Core.Navigation.Regions
{
    ...
    public class ViewRegisteredEventArgs : EventArgs
    {
        ...
        public ViewRegisteredEventArgs(string regionName, Func<IServiceProvider, object> getViewDelegate)
        {
        ...
        /// </summary>
        public Func<IServiceProvider, object> GetView { get; private set; }
    }
}
