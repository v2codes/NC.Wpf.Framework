...
namespace NC.Wpf.Core.Navigation.Regions
{
    ...
    public class RegionBehaviorFactory : IRegionBehaviorFactory
    {
        ...
        public RegionBehaviorFactory(IServiceProvider container)
        {
        ...
        public IRegionBehavior CreateFromKey(string key)
        {
            ...
            return (IRegionBehavior)_container.GetRequiredService(_registeredBehaviors[key]);
        }
