...
namespace NC.Wpf.Framework.Extensions
{
    ...
    public static class ContainerRegistryExtensions
    {
        ...
        public static void RegisterDialog<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TView>(this IServiceCollection containerRegistry, string name = null)
        {
        ...
        /// <param name="containerRegistry"></param>
        public static void RegisterDialogWindow<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TWindow>(this IServiceCollection containerRegistry) where TWindow : Dialogs.IDialogWindow
        {
            containerRegistry.AddTransient(typeof(Dialogs.IDialogWindow), typeof(TWindow));
        }
        ...
        public static void RegisterDialogWindow<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TWindow>(this IServiceCollection containerRegistry, string name) where TWindow : Dialogs.IDialogWindow
        {
            containerRegistry.AddKeyedTransient(typeof(Dialogs.IDialogWindow), name, typeof(TWindow));
        }
        ...
        /// <param name="containerRegistry"></param>
        /// <param name="name">The unique name to register with the object.</param>
        public static void RegisterForNavigation<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] T>(this IServiceCollection containerRegistry, string name = null)
        {
            Type type = typeof(T);
        ...
        private static void RegisterForNavigationWithViewModel<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors | DynamicallyAccessedMemberTypes.NonPublicConstructors)] TViewModel>(this IServiceCollection containerRegistry, Type viewType, string name)
        {
