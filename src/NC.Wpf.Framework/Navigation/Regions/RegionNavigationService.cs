...
namespace NC.Wpf.Framework.Navigation.Regions
{
    ...
    public class RegionNavigationService : IRegionNavigationService
    {
        ...
        public RegionNavigationService(IServiceProvider container, IRegionNavigationContentLoader regionNavigationContentLoader, IRegionNavigationJournal journal)
        {
        ...
        private void ExecuteNavigation(NavigationContext navigationContext, object[] activeViews, Action<NavigationResult> navigationCallback)
        {
            try
            {
                ...
                IRegionNavigationJournalEntry journalEntry = _container.GetService<IRegionNavigationJournalEntry>();
