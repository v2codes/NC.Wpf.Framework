...
namespace NC.Wpf.Framework.Navigation.Regions
{
    ...
    public class RegionViewRegistry : IRegionViewRegistry
    {
        ...
        public RegionViewRegistry(IServiceProvider container)
        {
        ...
        public IEnumerable<object> GetContents(string regionName, IServiceProvider container)
        {
            var items = new List<object>();
            foreach (Func<IServiceProvider, object> getContentDelegate in _registeredContent[regionName])
            {
        ...
        public void RegisterViewWithRegion(string regionName, Func<IServiceProvider, object> getContentDelegate)
        {
        ...
        {
            var view = _container.GetService(type);
