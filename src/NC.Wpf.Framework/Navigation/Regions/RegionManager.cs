...
namespace NC.Wpf.Framework.Navigation.Regions
{
    ...
    public class RegionManager : IRegionManager
    {
        ...
        private static void CreateRegion(DependencyObject element)
        {
            ...
            DelayedRegionCreationBehavior regionCreationBehavior = container.GetService<DelayedRegionCreationBehavior>();
        ...
        public static void UpdateRegions()
        {
            ...
            catch (TargetInvocationException ex)
            {
                ...
                throw new UpdateRegionsException(string.Format(CultureInfo.CurrentCulture, Resources.UpdateRegionException, rootException), ex.InnerException);
            }
        }
        ...
        {
            var regionViewRegistry = ContainerLocator.Container.GetService<IRegionViewRegistry>();
        ...
        /// <returns>The <see cref="IRegionManager"/>, for adding several views easily</returns>
        public IRegionManager RegisterViewWithRegion(string regionName, Func<IServiceProvider, object> getContentDelegate)
        {
            var regionViewRegistry = ContainerLocator.Container.GetService<IRegionViewRegistry>();
